...
#   Rscript tools/development/architecture/build_target_architecture_plan.R
...
if (
  ...
  stop(
    paste0(
      ...
      "Run tools/development/history/legacy-baseline/inventory_legacy_architecture.R again."
    ),
    call. = FALSE
  )
}
