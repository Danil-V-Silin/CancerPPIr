...
#
# Usage:
#   Rscript tools/development/architecture/run_architecture_checkpoint_all_cases.R <output_root>
#
# Example:
#   Rscript tools/development/architecture/run_architecture_checkpoint_all_cases.R \
