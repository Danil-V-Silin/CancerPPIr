...
#
# Usage:
# Rscript tools/development/history/legacy-baseline/finalize_legacy_baseline.R \
...
source("tools/development/history/legacy-baseline/postprocess_legacy_baseline.R", local = TRUE)
