...
#
# Usage:
#   Rscript tools/development/history/legacy-baseline/inventory_legacy_outputs.R
#
# Optional custom output root:
#   Rscript tools/development/history/legacy-baseline/inventory_legacy_outputs.R ../results/legacy_baseline_2026-07-15
